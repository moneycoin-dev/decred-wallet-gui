...
public class StakingPurchase extends Interface {
	...
	public void init() {		
		...
		this.components.add(new Button("cancel", Constants.getLangValue("Cancel-Button-Text"), 40, 520, 100, 35, Constants.flatRed, Constants.flatRedHover));
		this.components.add(new Button("confirm", Constants.getLangValue("Confirm-Button-Text"), Engine.getWidth() - 140, 520, 100, 35, Constants.flatBlue, Constants.flatBlueHover));
