		...
		case 0: //Statistics 
			...
			if(Constants.globalCache.tickets != null){
				for(int i = 0; i < Constants.globalCache.tickets.size(); i++){
					if(220 + i*70 - scrollOffset < Engine.getHeight() && 220 + i*70 - scrollOffset > 80){
						...
						if(vbHoverId == i) g.setColor(Constants.flatBlue); else g.setColor(Constants.walletBalanceColor);
						g.setFont(Constants.walletBalanceFont);
			...
			if(Constants.globalCache.stakeInfo != null && Constants.globalCache.stakeInfo.size() > 0 && Constants.globalCache.stakeInfo.get(0).getValueByName("poolsize") != null){
				g.setColor(Constants.walletBalanceColor);
				g.setFont(Constants.walletBalanceFont);
				g.drawString(Constants.globalCache.stakeInfo.get(0).getValueByName("poolsize"), headerThird - (headerThird / 2) - (g.getFontMetrics().stringWidth(Constants.globalCache.stakeInfo.get(0).getValueByName("poolsize")) / 2), 190);
				g.drawString(Constants.globalCache.stakeInfo.get(0).getValueByName("difficulty"), (headerThird * 2) - (headerThird / 2) - (g.getFontMetrics().stringWidth(Constants.globalCache.stakeInfo.get(0).getValueByName("difficulty")) / 2), 190);
				
				g.drawString(Constants.globalCache.stakeInfo.get(0).getValueByName("allmempool"), (headerThird * 3) - (headerThird / 2) - (g.getFontMetrics().stringWidth(Constants.globalCache.stakeInfo.get(0).getValueByName("allmempool")) / 2), 190);
				g.drawString(Constants.globalCache.stakeInfo.get(0).getValueByName("ownmempool"), (headerThird * 4) - (headerThird / 2) - (g.getFontMetrics().stringWidth(Constants.globalCache.stakeInfo.get(0).getValueByName("ownmempool")) / 2), 190);
				g.drawString(Constants.globalCache.stakeInfo.get(0).getValueByName("immature"), (headerThird * 5) - (headerThird / 2) - (g.getFontMetrics().stringWidth(Constants.globalCache.stakeInfo.get(0).getValueByName("immature")) / 2), 190);
				
				g.drawString(Constants.globalCache.stakeInfo.get(0).getValueByName("live"), (headerThird * 6) - (headerThird / 2) - (g.getFontMetrics().stringWidth(Constants.globalCache.stakeInfo.get(0).getValueByName("live")) / 2), 190);
				g.drawString(Constants.globalCache.stakeInfo.get(0).getValueByName("voted"), (headerThird * 7) - (headerThird / 2) - (g.getFontMetrics().stringWidth(Constants.globalCache.stakeInfo.get(0).getValueByName("voted")) / 2), 190);
				g.drawString(Constants.globalCache.stakeInfo.get(0).getValueByName("missed"), (headerThird * 8) - (headerThird / 2) - (g.getFontMetrics().stringWidth(Constants.globalCache.stakeInfo.get(0).getValueByName("missed")) / 2), 190);
				g.drawString(Constants.globalCache.stakeInfo.get(0).getValueByName("revoked"), (headerThird * 9) - (headerThird / 2) - (g.getFontMetrics().stringWidth(Constants.globalCache.stakeInfo.get(0).getValueByName("revoked")) / 2), 190);
			}
