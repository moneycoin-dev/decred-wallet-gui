...
public class Login extends Interface {	
	...
	public void init() {
		...
		LinkLabel helpLabel = new LinkLabel("help","Need Help?", "https://decred.org", Engine.getWidth() / 2 - 40, Engine.getHeight() / 2 + 200);
		...
		importLabel.setTextColor(Constants.flatBlue);
		...
		this.components.add(new Button("confirm", Constants.getLangValue("Confirm-Button-Text"), Engine.getWidth() / 2 - 75, Engine.getHeight() / 2 + 110, 150, 35, Constants.flatBlue, Constants.flatBlueHover));
						...
						if(getComponentByName("address").text == "" || getComponentByName("address").text == "localhost" || getComponentByName("address").text == "127.0.0.0.1") {
							...
							if(Processes.getClosestProcess("dcrd") == -1){ 
								JOptionPane.showMessageDialog(null, 
										"Starting local DCRD process, this may take a minute.",
										"Decred Wallet",
	...
	public void render(Graphics2D g) {
		...
		//Login form
		g.setColor(Constants.loggedinBackgroundColor);
