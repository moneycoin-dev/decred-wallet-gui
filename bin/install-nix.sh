...
sudo cp decred /usr/bin/
sudo cp DecredWallet.jar /usr/bin/

#Copy icon to icon folder
sudo cp resources/decred.png /usr/share/icons/ 

#Create .desktop file
sudo cp resources/Decred.desktop /usr/share/applications/ 

#Create .local desktop file
cp resources/Decred.desktop $HOME/.local/share/applications/
